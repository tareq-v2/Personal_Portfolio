...
<section class="banner-main-section py-5 all-pages-input" id="main">
    <div class="row">
        <div class="col-12">
            <h2 class="dash-ad-title m-0 mb-3">Admin Dashboard | <span class="dash-span-title"> Skills List</span></h2>
        </div>
    </div>
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">List of all Skills</h4>
                                @if (session('success'))
                                <br>
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" rowspan="1" colspan="1"
                                                            style="width: 88.1406px;">skills Name</th>
                                                        <th class="sorting" rowspan="1" colspan="1"
                                                            style="width: 141px;">skills Percentage</th>
                                                        <th class="sorting" rowspan="1" colspan="1"
                                                        ...
                                                        <td>
                                                            <div class="navbar">
                                                                ...
                                                                <div class="dropdown-menu drp-menu"
                                                                    ...
                                                                    {{-- <a class="dropdown-item" href="{{ route('skills.show', $item->id) }}">
                                                                        <i class="far fa-eye"></i>
                                                                        <span>Show</span>
                                                                    </a> --}}
                                                                    <a class="dropdown-item" href="{{ route('skills.edit', $item->id) }}">
                                                                    ...
                                                                    <form class="dropdown-item" action="{{ route('skills.destroy', $item->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
