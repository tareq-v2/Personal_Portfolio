...
@section('content')
    <section class="banner-main-section py-5 all-pages-input" id="main">
        <div class="row">
            <div class="col-12">
                <h2 class="dash-ad-title m-0 mb-3">Admin Dashboard | <span class="dash-span-title"> Services List </span></h2>
            </div>
        </div>
                ...
                <div class="col-12"> 
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">List of all the Services</h4>
                            @if (session('success'))
                                <br>
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" rowspan="1" colspan="1"
                                                        style="width: 88.1406px; text-align: center">Icon</th>
                                                    <th class="sorting" rowspan="1" colspan="1"
                                                        style="width: 141px;">Title</th>
                                                    <th class="sorting" rowspan="1" colspan="1"
                                                            ...
                                                            <div class="navbar">
                                                                ...
                                                                <div class="dropdown-menu drp-menu"
                                                                    ...
                                                                    <form class="dropdown-item"
                                                                        ...
                                                                        <button type="submit"
                                                                            class="btn text-dark p-0 m-0"
                                                                            style=" box-shadow:none; background:none">Delete</button>
                                                                    </form>
