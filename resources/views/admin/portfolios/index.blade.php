...
<section class="banner-main-section py-5 all-pages-input" id="main">
    <div class="row">
        <div class="col-12">
            <h2 class="dash-ad-title m-0 mb-3">Admin Dashboard | <span class="dash-span-title"> Portfolio List</span></h2>
        </div>
    </div>
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">List of all the Portfolio</h4>
                                @if (session('success'))
                                <br>
                                            ...
                                            <table id="data_table" class="table table-bordered dataTable no-footer "    
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" rowspan="1" colspan="1"
                                                            style="width: 141px;">Portfolio Title</th>
                                                        <th class="sorting" rowspan="1" colspan="1"
                                                            style="width: 141px;">Details</th> 
                                                        <th class="sorting" rowspan="1" colspan="1"
                                                            style="width: 141px;">Thumbnail Image</th>
                                                        <th class="sorting" rowspan="1" colspan="1"
                                                ...
                                                <tbody> 
                                                    ...
                                                    <tr role="row">
                                                        ...
                                                        <td>
                                                            <span class=""> {{ $item->getCategory->name }} </span>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <span class=""> {{ Str::limit($item->details, 100) }} </span>
                                                        </td> 
                                                        
                                                        <td>
                                                            <img src="{{ asset('uploads/portfolio')}}/{{ $item->thum_image }}" width="150"
                                                            alt="portfolio">
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="navbar">
                                                                ...
                                                                <div class="dropdown-menu drp-menu"
                                                                    ...
                                                                    <a class="dropdown-item" href="{{ route('portfolios.show', $item->id) }}">
                                                                        <i class="far fa-eye"></i>
                                                                        <span>Show</span>
                                                                    </a>
                                                                    <a class="dropdown-item" href="{{ route('portfolios.edit', $item->id) }}">
                                                                    ...
                                                                    <form class="dropdown-item" action="{{ route('portfolios.destroy', $item->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
