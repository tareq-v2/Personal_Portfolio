...
<section class="banner-main-section py-5 all-pages-input" id="main">
    <div class="row">
        <div class="col-12">
            <h2 class="dash-ad-title m-0 mb-3">Admin Dashboard | <span class="dash-span-title"> Educations</span></h2>
        </div>
    </div>
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">List of all Degree</h4>
                                @if (session('success'))
                                <br>
                                            ...
                                            <table id="data_table" class="table table-bordered dataTable no-footer "    
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" rowspan="1" colspan="1"
                                                            style="width: 88.1406px;">Period</th>
                                                        <th class="sorting" rowspan="1" colspan="1"
                                                            style="width: 141px;">Program </th>
                                                        <th class="sorting" rowspan="1" colspan="1"
                                                            style="width: 141px;">Institute</th>
                                                        <th class="sorting" rowspan="1" colspan="1"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr role="row">
                                                        ...
                                                        <td>
                                                            <span class=""> {{ $item->institute }} </span>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div class="navbar">
                                                                ...
                                                                <div class="dropdown-menu drp-menu"
                                                                    ...
                                                                    <a class="dropdown-item" href="{{ route('educations.show', $item->id) }}">
                                                                    ...
                                                                    <form class="dropdown-item" action="{{ route('educations.destroy', $item->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
