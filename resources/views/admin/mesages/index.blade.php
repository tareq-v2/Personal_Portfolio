...
<section class="banner-main-section py-5 all-pages-input" id="main">
    <div class="row">
        <div class="col-12">
            <h2 class="dash-ad-title m-0 mb-3">Admin Dashboard | <span class="dash-span-title"> Messages List</span></h2>
        </div>
    </div>
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting" rowspan="1" colspan="1"
                                                            style="width: 141px;">Name</th>
                                                        <th class="sorting" rowspan="1" colspan="1"
                                                            style="width: 141px;">Email</th>
                                                        <th class="sorting" rowspan="1" colspan="1"
                                                            style="width: 141px;">Subject</th>
                                                        <th class="sorting" rowspan="1" colspan="1"
                                                        ...
                                                        <td>
                                                            <div class="navbar">
                                                                ...
                                                                <div class="dropdown-menu drp-menu"
                                                                    ...
                                                                    {{-- <a class="dropdown-item" href="{{ route('servicesLists.edit', $item->id) }}">
                                                                    ...
                                                                    <form class="dropdown-item" action="{{ route('message.destroy') }}" method="POST">
                                                                        @csrf 
