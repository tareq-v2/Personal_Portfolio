...
(() =>{
	...
	function popupSlideshow(){
	 ...
	 function popupDetails(){
	 	...
	 	const description = portfolioItems[itemIndex].querySelector(".details").innerHTML;
	 	...
	 	const category = portfolioItems[itemIndex].getAttribute("data-cat");
...
// Add active class to the desktop menu
    var header = document.getElementById("navbar_top");
    var btns = header.getElementsByClassName("link-item1");
